...
public class Ahe 
{
	...
	public static ArrayList<Integer> GetInputMatrixForSpecificID(int id, ArrayList<ArrayList<Integer>> matrix, int numOfRows, int numOfColumns)
	{
	...
	public static SingleMeterOutput GetMeterOutputFromSingleMachineBySpecificPartOfMatrix(int id,float input, ArrayList<Integer> specificPartOfMatrix, int sizeOfColumn, ArrayList<Integer> randomVariables)
	{
		int tempIndex = 0;
		float maskValue = 0;
	...
	public static ArrayList<SingleMeterOutput> GetMeterOutput(float inputArray[], int length, ArrayList<ArrayList<Integer>> matrixA, int numOfRows, int numOfColumns, ArrayList<Integer> randomVariable)
	{
		...
		for(i=0 ; i<length ; i++)
		{
			...
			{
				tempArray.add(GetMeterOutputFromSingleMachineBySpecificPartOfMatrix(id,inputArray[i], matrixOfColumn, numOfColumns, randomVariable));
	...
	public static SinkOutput GetSinkOutput(ArrayList<SingleMeterOutput> outputArrayFromMeter, int length, ArrayList<ArrayList<Integer>> matrixA, int numOfRows, int numOfColumns)
	{
		...
		// Compute y[k], where k = 1 ~ m. y[k] = a_(1,k)*1 + a_(2,k)*1 + ....+ a_(n,k)*1.
		int k = 0;
		float var ;
